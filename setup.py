...
setup(
    ...
    keywords='tendril',
    url='https://github.com/tendril-framework/tendril-schema',
    project_urls={
        'Documentation': 'https://tendril-schema.readthedocs.io/en/latest',
        'Bug Tracker': 'https://github.com/tendril-framework/tendril-schema/issues',
        'Source Repository': 'https://github.com/tendril-framework/tendril-schema',
    },
